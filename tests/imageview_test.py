...
QTest.keyClick(iv, Qt.Key_PageDown, Qt.NoModifier, 100)
QTest.keyClick(iv, Qt.Key_PageDown, Qt.NoModifier, 100)
QTest.keyClick(iv, Qt.Key_PageDown, Qt.NoModifier, 100)
QTest.keyClick(iv, Qt.Key_PageDown, Qt.NoModifier, 100)
QTest.keyClick(iv, Qt.Key_PageDown, Qt.NoModifier, 100)
QTest.keyClick(iv, Qt.Key_PageUp, Qt.NoModifier, 100)
QTest.keyClick(iv, Qt.Key_PageUp, Qt.NoModifier, 100)

# click on the pct spinner and key a couple of numbers
pct = iv.zoom_pct # totally cheating here
QTest.mouseClick(pct,Qt.LeftButton)
QTest.keyClick(pct,Qt.Key_A,Qt.ControlModifier,250)
QTest.keyClicks(pct,'22')

# key the zoom keys a few times
QTest.keyClick(iv, Qt.Key_Plus, Qt.ControlModifier, 100)
QTest.keyClick(iv, Qt.Key_Plus, Qt.ControlModifier, 100)
QTest.keyClick(iv, Qt.Key_Plus, Qt.ControlModifier, 100)
QTest.keyClick(iv, Qt.Key_Plus, Qt.ControlModifier, 100)
QTest.keyClick(iv, Qt.Key_Minus, Qt.ControlModifier, 100)
QTest.keyClick(iv, Qt.Key_Minus, Qt.ControlModifier, 100)
QTest.keyClick(iv, Qt.Key_Minus, Qt.ControlModifier, 100)
QTest.keyClick(iv, Qt.Key_Minus, Qt.ControlModifier, 100)
QTest.keyClick(iv, Qt.Key_Minus, Qt.ControlModifier, 100)
...
QTest.mouseClick(tow,Qt.LeftButton)
QTest.qWait(1000)
QTest.mouseClick(toh,Qt.LeftButton)
QTest.qWait(1000)
